...
section .data
	...
	big_sizeGr_ms db "El tamaño del grupo no puede ser mayor a 25"
	big_sizeSc_ms db "El tamaño de la escala no puede ser mayor a 25"
...
_start:
    ...
    ;mov al, [notaAp]
    ;mov al, [notaRe]
    ;mov al, [ord]   ; aquí debe detenerse el programa porque la configuración es guardada es  7
    ;mov al, [escala]
    ;cmp al, 7
    ;je _finish_prog
	;jmp _finish_prog
...
errorGroup:
	mov rsi, big_sizeGr_msg
	call _print
	
	call _finish_prog

errorGroup:
	mov rsi, big_sizeSc_msg
	call _print
